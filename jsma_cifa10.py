...
from __future__ import unicode_literalspicklable
'''
import numpy as np
...
#from utils_cifar import read_CIFAR10
from cleverhans.attacks import SaliencyMapMethod
from cleverhans.utils import other_classes, set_log_level
from cleverhans.utils import pair_visual, AccuracyReport
...
from tutor_model import make_basic_picklable_cnn
from cifa import data_CIFAR10
...
"""
def cifar_tutorial_jsma(train_start=0, train_end=60000, test_start=0,
    ...
    perturbations = np.zeros((nb_classes, source_samples), dtype='f') #f = floating
    ...
    for sample_ind in xrange(0, source_samples):  #source_samples set 10
        ...
        for target in target_classes:
            ...
            grid_viz_data[target, current_class, :, :, :] = np.reshape(adv_x, (img_rows, img_cols, channels))
...
def main(argv=None):
    cifar_tutorial_jsma(viz_enabled=FLAGS.viz_enabled,
